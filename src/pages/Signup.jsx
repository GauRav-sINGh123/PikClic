...
function Login() {
  ...
  return (
    ...
    <div className="bg-white w-96 shadow-xl rounded p-5">
      <h1 className="text-3xl text-neutral-800 font-medium text-center">Welcome</h1>
      <p className="text-sm text-neutral-600 text-center ">Create A New Account</p>
      <form onSubmit={handleSubmit} className="space-y-5 mt-5">
        ...
        <div className="">
          <p
            ...
            className="font-medium text-sm text-blue-600 hover:text-blue-800 hover:scale-105  hover:-translate-y-0.5 transition ease-in-out rounded-md p-2"
          >
